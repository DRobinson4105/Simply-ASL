...
class Model(nn.Module):
    def __init__(self, args):
        ...
        self.Transformer_encoder_1 = Transformer_encoder(4, args.frames, args.frames*2, length=2*args.n_joints, h=6)
        self.Transformer_encoder_2 = Transformer_encoder(4, args.frames, args.frames*2, length=2*args.n_joints, h=6)
        self.Transformer_encoder_3 = Transformer_encoder(4, args.frames, args.frames*2, length=2*args.n_joints, h=6)
    ...
    def forward(self, x): 
        ...
        ## MHG
        print(x.shape)
        print(self.norm_1(x).shape)
        print(self.Transformer_encoder_1(self.norm_1(x)))
